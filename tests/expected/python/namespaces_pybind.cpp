...
PYBIND11_MODULE(namespaces_py, m_) {
    ...
    m_ns1.def("aGlobalFunction",&ns1::aGlobalFunction);    pybind11::module m_ns2 = m_.def_submodule("ns2", "ns2 submodule");

    py::class_<ns2::ClassA, std::shared_ptr<ns2::ClassA>>(m_ns2, "ClassA")
        .def(py::init<>())
        .def("memberFunction",&ns2::ClassA::memberFunction)
        .def("nsArg",&ns2::ClassA::nsArg, gtwrap::internal::py_arg<const ns1::ClassB&>("arg"))
        .def("nsReturn",&ns2::ClassA::nsReturn, gtwrap::internal::py_arg<double>("q"))
        .def_static("afunction",&ns2::ClassA::afunction);
    ...
    m_ns2.def("aGlobalFunction",&ns2::aGlobalFunction);
    m_ns2.def("overloadedGlobalFunction",py::overload_cast<const ns1::ClassA&>(&ns2::overloadedGlobalFunction), gtwrap::internal::py_arg<const ns1::ClassA&>("a"));
    m_ns2.def("overloadedGlobalFunction",py::overload_cast<const ns1::ClassA&, double>(&ns2::overloadedGlobalFunction), gtwrap::internal::py_arg<const ns1::ClassA&>("a"), gtwrap::internal::py_arg<double>("b"));
    ...
    py::class_<gtsam::Values, std::shared_ptr<gtsam::Values>>(m_gtsam, "Values")
        ...
        .def("insert",py::overload_cast<size_t, const gtsam::Vector&>(&gtsam::Values::insert), gtwrap::internal::py_arg<size_t>("j"), gtwrap::internal::py_arg<const gtsam::Vector&>("vector"))
        ...
        .def("insert",py::overload_cast<size_t, const gtsam::Matrix&>(&gtsam::Values::insert), gtwrap::internal::py_arg<size_t>("j"), gtwrap::internal::py_arg<const gtsam::Matrix&>("matrix"));
