...
PYBIND11_MODULE(geometry_py, m_) {
    ...
    py::class_<gtsam::Point2, std::shared_ptr<gtsam::Point2>>(m_gtsam, "Point2")
        ...
        .def("x",&gtsam::Point2::x)
        .def("y",&gtsam::Point2::y)
        .def("dim",&gtsam::Point2::dim)
        .def("returnChar",&gtsam::Point2::returnChar)
        .def("argChar",py::overload_cast<char>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<char>("a"))
        .def("argChar",py::overload_cast<std::shared_ptr<char>>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<std::shared_ptr<char>>("a"))
        .def("argChar",py::overload_cast<char&>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<char&>("a"))
        .def("argChar",py::overload_cast<char*>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<char*>("a"))
        .def("argChar",py::overload_cast<const std::shared_ptr<char>>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<const std::shared_ptr<char>>("a"))
        .def("argChar",py::overload_cast<const char&>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<const char&>("a"))
        .def("argChar",py::overload_cast<const char*>(&gtsam::Point2::argChar, py::const_), gtwrap::internal::py_arg<const char*>("a"))
        .def("argUChar",&gtsam::Point2::argUChar, gtwrap::internal::py_arg<unsigned char>("a"))
        .def("eigenArguments",&gtsam::Point2::eigenArguments, gtwrap::internal::py_arg<const gtsam::Vector&>("v"), gtwrap::internal::py_arg<const gtsam::Matrix&>("m"))
        .def("vectorConfusion",&gtsam::Point2::vectorConfusion)
    ...
    py::class_<gtsam::Point3, std::shared_ptr<gtsam::Point3>>(m_gtsam, "Point3")
        ...
        .def_static("StaticFunctionRet",&gtsam::Point3::StaticFunctionRet, gtwrap::internal::py_arg<double>("z"));
