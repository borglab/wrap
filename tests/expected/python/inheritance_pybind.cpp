...
PYBIND11_MODULE(inheritance_py, m_) {
    ...
    py::class_<MyTemplate<gtsam::Point2>, MyBase, std::shared_ptr<MyTemplate<gtsam::Point2>>>(m_, "MyTemplatePoint2")
        ...
        .def("accept_T",&MyTemplate<gtsam::Point2>::accept_T, gtwrap::internal::py_arg<const gtsam::Point2&>("value"))
        .def("accept_Tptr",&MyTemplate<gtsam::Point2>::accept_Tptr, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Point2>>("value"))
        .def("return_Tptr",&MyTemplate<gtsam::Point2>::return_Tptr, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Point2>>("value"))
        .def("return_T",&MyTemplate<gtsam::Point2>::return_T, gtwrap::internal::py_arg<gtsam::Point2*>("value"))
        .def("create_ptrs",&MyTemplate<gtsam::Point2>::create_ptrs)
        .def("create_MixedPtrs",&MyTemplate<gtsam::Point2>::create_MixedPtrs)
        .def("return_ptrs",&MyTemplate<gtsam::Point2>::return_ptrs, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Point2>>("p1"), gtwrap::internal::py_arg<std::shared_ptr<gtsam::Point2>>("p2"))
        .def_static("Level",&MyTemplate<gtsam::Point2>::Level, gtwrap::internal::py_arg<const gtsam::Point2&>("K"));
    ...
    py::class_<MyTemplate<gtsam::Matrix>, MyBase, std::shared_ptr<MyTemplate<gtsam::Matrix>>>(m_, "MyTemplateMatrix")
        ...
        .def("accept_T",&MyTemplate<gtsam::Matrix>::accept_T, gtwrap::internal::py_arg<const gtsam::Matrix&>("value"))
        .def("accept_Tptr",&MyTemplate<gtsam::Matrix>::accept_Tptr, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Matrix>>("value"))
        .def("return_Tptr",&MyTemplate<gtsam::Matrix>::return_Tptr, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Matrix>>("value"))
        .def("return_T",&MyTemplate<gtsam::Matrix>::return_T, gtwrap::internal::py_arg<gtsam::Matrix*>("value"))
        .def("create_ptrs",&MyTemplate<gtsam::Matrix>::create_ptrs)
        .def("create_MixedPtrs",&MyTemplate<gtsam::Matrix>::create_MixedPtrs)
        .def("return_ptrs",&MyTemplate<gtsam::Matrix>::return_ptrs, gtwrap::internal::py_arg<std::shared_ptr<gtsam::Matrix>>("p1"), gtwrap::internal::py_arg<std::shared_ptr<gtsam::Matrix>>("p2"))
        .def_static("Level",&MyTemplate<gtsam::Matrix>::Level, gtwrap::internal::py_arg<const gtsam::Matrix&>("K"));
    ...
    py::class_<MyTemplate<A>, MyBase, std::shared_ptr<MyTemplate<A>>>(m_, "MyTemplateA")
        ...
        .def("accept_T",&MyTemplate<A>::accept_T, gtwrap::internal::py_arg<const A&>("value"))
        .def("accept_Tptr",&MyTemplate<A>::accept_Tptr, gtwrap::internal::py_arg<std::shared_ptr<A>>("value"))
        .def("return_Tptr",&MyTemplate<A>::return_Tptr, gtwrap::internal::py_arg<std::shared_ptr<A>>("value"))
        .def("return_T",&MyTemplate<A>::return_T, gtwrap::internal::py_arg<A*>("value"))
        .def("create_ptrs",&MyTemplate<A>::create_ptrs)
        .def("create_MixedPtrs",&MyTemplate<A>::create_MixedPtrs)
        .def("return_ptrs",&MyTemplate<A>::return_ptrs, gtwrap::internal::py_arg<std::shared_ptr<A>>("p1"), gtwrap::internal::py_arg<std::shared_ptr<A>>("p2"))
        .def_static("Level",&MyTemplate<A>::Level, gtwrap::internal::py_arg<const A&>("K"));
    ...
    py::class_<Base, std::shared_ptr<Base>>(m_, "Base")
        .def_static("Create",&Base::Create, gtwrap::internal::py_arg<double>("x"));
