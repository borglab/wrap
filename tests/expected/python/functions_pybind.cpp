...
PYBIND11_MODULE(functions_py, m_) {
    ...
    m_.def("load2D",py::overload_cast<string, std::shared_ptr<Test>, int, bool, bool>(&::load2D), gtwrap::internal::py_arg<string>("filename"), gtwrap::internal::py_arg<std::shared_ptr<Test>>("model"), gtwrap::internal::py_arg<int>("maxID"), gtwrap::internal::py_arg<bool>("addNoise"), gtwrap::internal::py_arg<bool>("smart"));
    m_.def("load2D",py::overload_cast<string, const std::shared_ptr<gtsam::noiseModel::Diagonal>, int, bool, bool>(&::load2D), gtwrap::internal::py_arg<string>("filename"), gtwrap::internal::py_arg<const std::shared_ptr<gtsam::noiseModel::Diagonal>>("model"), gtwrap::internal::py_arg<int>("maxID"), gtwrap::internal::py_arg<bool>("addNoise"), gtwrap::internal::py_arg<bool>("smart"));
    m_.def("load2D",py::overload_cast<string, gtsam::noiseModel::Diagonal*>(&::load2D), gtwrap::internal::py_arg<string>("filename"), gtwrap::internal::py_arg<gtsam::noiseModel::Diagonal*>("model"));
    m_.def("aGlobalFunction",&::aGlobalFunction);
    m_.def("overloadedGlobalFunction",py::overload_cast<int>(&::overloadedGlobalFunction), gtwrap::internal::py_arg<int>("a"));
    m_.def("overloadedGlobalFunction",py::overload_cast<int, double>(&::overloadedGlobalFunction), gtwrap::internal::py_arg<int>("a"), gtwrap::internal::py_arg<double>("b"));
    ...
    m_.def("DefaultFuncInt",&::DefaultFuncInt, gtwrap::internal::py_arg<int>("a") = 123, gtwrap::internal::py_arg<int>("b") = 0);
    m_.def("DefaultFuncString",&::DefaultFuncString, gtwrap::internal::py_arg<const string&>("s") = "hello", gtwrap::internal::py_arg<const string&>("name") = "");
    m_.def("DefaultFuncObj",&::DefaultFuncObj, gtwrap::internal::py_arg<const gtsam::KeyFormatter&>("keyFormatter") = gtsam::DefaultKeyFormatter);
    m_.def("DefaultFuncZero",&::DefaultFuncZero, gtwrap::internal::py_arg<int>("a"), gtwrap::internal::py_arg<int>("b"), gtwrap::internal::py_arg<double>("c") = 0.0, gtwrap::internal::py_arg<int>("d") = 0, gtwrap::internal::py_arg<bool>("e") = false);
    m_.def("DefaultFuncVector",&::DefaultFuncVector, gtwrap::internal::py_arg<const std::vector<int>&>("i") = {1, 2, 3}, gtwrap::internal::py_arg<const std::vector<string>&>("s") = {"borglab", "gtsam"});
    m_.def("setPose",&::setPose, gtwrap::internal::py_arg<const gtsam::Pose3&>("pose") = gtsam::Pose3());
    m_.def("EliminateDiscrete",&::EliminateDiscrete, gtwrap::internal::py_arg<const gtsam::DiscreteFactorGraph&>("factors"), gtwrap::internal::py_arg<const gtsam::Ordering&>("frontalKeys"));
