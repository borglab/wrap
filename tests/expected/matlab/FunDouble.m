...
%templatedStaticMethod(int m) : returns double
%
...
classdef FunDouble < handle
  ...
  methods(Static = true)
    ...
    function varargout = TemplatedStaticMethod(varargin)
      % TEMPLATEDSTATICMETHOD usage: templatedStaticMethod(int m) : returns double
      % Doxygen can be found at https://gtsam.org/doxygen/
      ...
      error('Arguments do not match any overload of function FunDouble.templatedStaticMethod');
    end
