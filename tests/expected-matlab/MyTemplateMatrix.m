...
classdef MyTemplateMatrix < MyBase
  ...
  methods
    function obj = MyTemplateMatrix(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = geometry_wrapper(66, varargin{2});
        end
        base_ptr = geometry_wrapper(65, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = geometry_wrapper(67);
      else
    ...
    function delete(obj)
      geometry_wrapper(68, obj.ptr_MyTemplateMatrix);
    end
    ...
    function varargout = create_ptrs(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        [ varargout{1} varargout{2} ] = geometry_wrapper(72, this, varargin{:});
        return
      end
    ...
    function varargout = templatedMethodVector(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = geometry_wrapper(79, this, varargin{:});
        return
      end
