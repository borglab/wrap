  ...
  methods
    function obj = Test(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        geometry_wrapper(22, my_ptr);
      elseif nargin == 0
        my_ptr = geometry_wrapper(23);
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'double')
        my_ptr = geometry_wrapper(24, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      geometry_wrapper(25, obj.ptr_Test);
    end
    ...
    function varargout = create_MixedPtrs(this, varargin)
      ...
      if length(varargin) == 0
        [ varargout{1} varargout{2} ] = geometry_wrapper(27, this, varargin{:});
        return
      end
    ...
    function varargout = create_ptrs(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        [ varargout{1} varargout{2} ] = geometry_wrapper(28, this, varargin{:});
        return
      end
    ...
    function varargout = print(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        geometry_wrapper(29, this, varargin{:});
        return
      end
    ...
    function varargout = return_pair(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        [ varargout{1} varargout{2} ] = geometry_wrapper(40, this, varargin{:});
        return
      end
    ...
    function varargout = return_ptrs(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'Test') && isa(varargin{2},'Test')
        [ varargout{1} varargout{2} ] = geometry_wrapper(41, this, varargin{:});
        return
      end
    ...
    function varargout = return_vector1(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = geometry_wrapper(44, this, varargin{:});
        return
      end
    ...
    function varargout = return_vector2(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = geometry_wrapper(45, this, varargin{:});
        return
      end
