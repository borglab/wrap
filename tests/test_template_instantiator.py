...
class TestInstantiatedGlobalFunction(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(self.func.force_pybind_adapter)
...
class TestInstantiatedMethod(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(self.method.force_pybind_adapter)
    ...
    def test_construct(self):
        ...
        self.assertEqual(instantiated_method.return_type.type1.get_typename(),
                         "string")
        self.assertTrue(instantiated_method.force_pybind_adapter)
...
class TestInstantiatedStaticMethod(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(self.static_method.force_pybind_adapter)
    ...
    def test_construct(self):
        ...
        self.assertEqual(
            ...
            "string")
        self.assertTrue(instantiated_static_method.force_pybind_adapter)
...
class TestTemplateInstantiator(unittest.TestCase):
    ...
    def test_annotation_survives_typedef_instantiation(self):
        """An adapter annotation on a templated member survives a typedef."""
